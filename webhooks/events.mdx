...
Triggered once per day, per conversation, when Bridge AI generates the daily summary. The summary captures the key points exchanged along with the IDs of the internal and external participants involved.
  ...
  <Tab title="Example payload">
    ```json
    {
      ...
      "payload": {
        ...
        "summary": "- Agent asked the customer about their preferred schedule and offered to book a product demo.\n- Customer replied they are unavailable on Monday morning.\n- Agent offered alternative slots later in the week and is waiting for confirmation.",
        "externalUserIds": ["c1d2e3f4-a5b6-7890-cdef-012345678901"],
        "internalUserIds": ["d4e5f6a7-b8c9-0123-defa-234567890123"],
