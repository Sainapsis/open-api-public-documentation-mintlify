...
<Steps>
  ...
  <Step title="View the documentation" icon="code" iconType="solid" stepNumber={2}>
    ...
    <Card title="Connect your agent" icon="bot-message-square" href="/connect-your-agent">
      Connect your AI coding assistant to this documentation through MCP so it answers from the published contract.
    </Card>
  </Step>
</Steps>