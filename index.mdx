...
<Icon icon="code" color="#2563EB" size={20} /> **Push data into Bridge: Rest API** — for example, sending contact details, messages, create new conversations, or lead updates from your CRM so they appear instantly in Bridge or allow your Bridge users to be connected immediately with your customers.

<Icon icon="webhook" color="#2563EB" size={20} /> **Receive data from Bridge: Webhooks** — for example, when a new conversation or contact is created / updated, Bridge can send event notifications (webhooks) back to your system in real time. This will allow you to have your CRM or any other system up to date.
