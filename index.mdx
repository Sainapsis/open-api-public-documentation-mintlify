...
<Icon icon="webhook" color="#2563EB" size={20} /> **Receive data from Bridge: Webhooks** — for example, when a new conversation or contact is created / updated, Bridge can send event notifications (webhooks) back to your system in real time. This will allow you to have your CRM up to date.
