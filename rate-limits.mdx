...
Each part of this contract implements an open specification. A client you already wrote against another API's rate limits should work here with little or no change.
